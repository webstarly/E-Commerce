...
const ProductVerticalCard = ({category, heading}) => {
    ...
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           {   loading ? (
            ...
            data.map((product,index)=>{
                return(
                    <Link to={"product/"+product?._id} key={index+"product"} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow '>
                        <div className='bg-slate-200  h-48 p-4 min-w-[120px] md:min-w-[145px] flex justify-center items-center'>
                            <img src={product.productImage[0]} alt='prductImage' className='object-scale-down h-full hover:scale-110 transition-all mix-blend-multiply'/>
                        </div>
